...
import {
  ArrowLeft, ArrowRight, BookOpen, Building, MapPin,
  DollarSign, Vote, Scale, Clock, GraduationCap,
} from 'lucide-react'

// Same guides data — in production, move to a shared file
const GUIDES: Record<string, any> = {
  'how-a-bill-becomes-law': {
    icon: BookOpen, category: 'Legislation', title: 'How a Bill Becomes Law',
    readTime: '3 min', color: 'text-indigo-600', bg: 'bg-indigo-50', border: 'border-indigo-200',
    content: [
  ...
  'three-branches': {
    icon: Building, category: 'Government Structure', title: 'The Three Branches of Government',
    readTime: '2 min', color: 'text-emerald-600', bg: 'bg-emerald-50', border: 'border-emerald-200',
    content: [
  ...
  'local-government': {
    icon: MapPin, category: 'Local Government', title: 'What Local Government Controls',
    readTime: '3 min', color: 'text-violet-600', bg: 'bg-violet-50', border: 'border-violet-200',
    content: [
  ...
  'understanding-taxes': {
    icon: DollarSign, category: 'Fiscal Policy', title: 'Understanding Property Taxes',
    readTime: '2 min', color: 'text-amber-600', bg: 'bg-amber-50', border: 'border-amber-200',
    content: [
  ...
  'how-voting-works': {
    icon: Vote, category: 'Voting', title: 'How Voting Works in America',
    readTime: '3 min', color: 'text-rose-600', bg: 'bg-rose-50', border: 'border-rose-200',
    content: [
  ...
  'congress-101': {
    icon: Scale, category: 'Congress', title: 'Congress 101: Senate vs. House',
    readTime: '2 min', color: 'text-sky-600', bg: 'bg-sky-50', border: 'border-sky-200',
    content: [
...
const GUIDE_ORDER = [
  'how-a-bill-becomes-law', 'three-branches', 'local-government',
  'understanding-taxes', 'how-voting-works', 'congress-101',
]
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="space-y-6 mb-10">
        {guide.content.map((section: any, i: number) => (
