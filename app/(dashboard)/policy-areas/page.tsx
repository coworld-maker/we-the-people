...
// Map policy areas to icons and colors for visual distinction
...
export default async function PolicyAreasPage() {
  ...
  // Aggregate bills by policy area with vote counts
      ...
      {areas.length === 0 ? (
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          {areas.map(area => {
            ...
            const active = area.count - enacted
            ...
            return (
              ...
              >
                ...
                {/* Mini bar showing vote activity relative to bill count */}
